...
public class ProfilePreview extends JFrame {
    ...
    public ProfilePreview(String email) {
        ...
        // --- FIX: Forced all text fields to load completely empty, except for Rating ---
        infoPanel.add(createEditableInfoField("Name:", ""));
        infoPanel.add(createEditableInfoField("Pets:", ""));
        infoPanel.add(createEditableInfoField("Lastname:", ""));
        infoPanel.add(createEditableInfoField("Preferences:", ""));
        infoPanel.add(createEditableInfoField("Age:", ""));
        infoPanel.add(createEditableInfoField("Email:", user.email));
        infoPanel.add(createEditableInfoField("Location:", ""));
        infoPanel.add(createEditableInfoField("Rating:", user.rating)); // Kept intact to load database rating
