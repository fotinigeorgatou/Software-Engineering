    ...
    class LoginCard extends JPanel {
        ...
        public LoginCard() {
            ...
            loginButton.addActionListener(e -> {
                ...
                // Βήμα 1.1: Έλεγχος Στοιχείων (Empty check)
                if(email.isEmpty()
                ...
                // --- FIX: Email Form Validation Validation Check ---
                String emailRegex = "^[A-Za-z0-9+_.-]+@[A-Za-z0-9.-]+\\.[A-Za-z]{2,}$";
                if (!email.matches(emailRegex)) {
                    JOptionPane.showMessageDialog(this, "Μήνυμα Error: Η διεύθυνση email δεν έχει έγκυρη μορφή (π.χ. user@example.com).", "Error", JOptionPane.ERROR_MESSAGE);
                    return;
                }

                if (password.length() < 6) {
                    JOptionPane.showMessageDialog(this, "Μήνυμα Error: Ο κωδικός πρόσβασης πρέπει να είναι τουλάχιστον 6 χαρακτήρες.", "Error", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                if (!hasLetter || !hasDigit) {
                    JOptionPane.showMessageDialog(this, "Μήνυμα Error: Ο κωδικός πρόσβασης πρέπει να περιέχει τουλάχιστον ένα γράμμα και έναν αριθμό.", "Error", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                // ... Rest of your existing login success/failure checks continue identically below ...
